...
file = open('new_dataset/Output_with_SOM/webkb_count_term_docvector_7229d/25/webkb_count_term_docvector_7229d_output_25.txt', 'w')
file1 = open('new_dataset/Output_with_SOM/webkb_count_term_docvector_7229d/25/webkb_count_term_docvector_7229d_output_generation_details_25.txt',
             'w')
...
# plt.savefig('new_dataset/Output_with_SOM/webkb_count_term_docvector_7229d/run1run1/webkb_count_term_docvector_7229d_output_run1.jpeg')
# plt.show()
