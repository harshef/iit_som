...
file = open('new_dataset/Output_without_SOM/webkb_count_term_docvector_7229d/15/webkb_count_term_docvector_7229d_output_15.txt', 'w')
file1 = open('new_dataset/Output_without_SOM/webkb_count_term_docvector_7229d/15/webkb_count_term_docvector_7229d_output_generation_details_15.txt',
             'w')
...
chromosome = 15  # Input the population size
