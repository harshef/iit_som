...
file = open('Text_Outputs/hierarchical/run6/bbc_gensin_50d_output_run1.txt', 'w')
file1= open('Text_Outputs/hierarchical/run6/bbc_gensin_50d_output_generation_details_run1.txt', 'w')

data = genfromtxt('dataset/nips/nips_gensim_doc_Wordvector_50d.csv', skip_header=0, usecols=range(0, 50)) ##Read the input data
...
plt.savefig('Text_Outputs/hierarchical/run1/bbc_gensin_50d_run1.jpeg')
plt.show()
