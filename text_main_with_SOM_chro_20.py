...
file = open('new_dataset/Output_with_SOM/webkb_count_term_docvector_7229d/20/webkb_count_term_docvector_7229d_output_20.txt', 'w')
file1 = open('new_dataset/Output_with_SOM/webkb_count_term_docvector_7229d/20/webkb_count_term_docvector_7229d_output_generation_details_20.txt',
             'w')
