...
file = open('Text_Outputs/nips_gensin_300d/run4/nips_gensim_doc_Wordvector_300d_output_run4.txt', 'w')
file1= open('Text_Outputs/nips_gensin_300d/run4/nips_gensim_doc_Wordvector_300d_output_generation_details_run4.txt', 'w')
...
plt.savefig('Text_Outputs/nips_gensin_300d/run4/nips_gensim_doc_Wordvector_300d_run4.jpeg')
plt.show()
